 ...
 * @author desmond
 */
public class ImporterTextListHandler extends ImporterGetHandler
{
    String version1;
     ...
     * @return 
     */
    private String getVersionPath( String row ) throws ImporterException
    {
        ...
        if ( cols.length >= 2 )
        {
            ...
            throw new ImporterException("wrong number of columns: "+cols.length);
    }
    /**
     ...
     */
    private String formatTable( String rawTable ) throws ImporterException
    {
        StringBuilder sb = new StringBuilder();
        ...
        HttpServletResponse response, String urn ) throws ImporterException
    {
        ...
        try
        {
            if ( urn.length()>0 )
            {
                ...
                throw new ImporterException("Invalid path "+urn);
        }
        catch ( Exception e )
        {
